...
DEFAULT_CONFIG_PATH = str(BASE_DIR / "data" / "xm126_bridge_config.json")
DEFAULT_EMPTY_ROOM_BASELINE_PATH = str(BASE_DIR / "data" / "xm126_empty_room_baseline.json")
DEFAULT_ML_MODEL_PATH = str(BASE_DIR / "data" / "ml" / "xm126_tiny_model.json")
