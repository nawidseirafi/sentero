...
def main() -> int:
    ...
    parser.add_argument("--output", default="data/ml/xm126_tiny_model.json")
    parser.add_argument("--report", default="data/ml/xm126_tiny_model_report.json")
    parser.add_argument("--segments", default="data/ml/xm126_training_segments.json")
    parser.add_argument("--excluded", default="data/ml/xm126_excluded_recordings.json")
    parser.add_argument(
        "--profile",
